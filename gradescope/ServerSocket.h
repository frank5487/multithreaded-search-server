...
//    void assignClientSide(int fd, struct sockaddr* addr, size_t addrlen);
//    void assignServerSide(int client_fd, int sock_family);
//    int handleClient(int c_fd, struct sockaddr* addr, size_t addrlen, int sock_family);
};
